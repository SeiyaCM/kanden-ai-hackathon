#!/bin/bash
#SBATCH -J posture_gen_v4_slouch
#SBATCH -p gpu
#SBATCH --gres=gpu:1
#SBATCH -c 8
#SBATCH --mem=32G
#SBATCH -o slurm-gen-v4-slouch-%j.out
...
echo "=== Starting v4 Generation: 02_slouch ==="

python -m venv myenv_slouch
...
python -u generate_dataset_openpose.py --class-name 02_slouch --num-variations 2500

deactivate
echo "=== Generation complete: 02_slouch ==="
