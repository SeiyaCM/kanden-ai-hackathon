#!/bin/bash
#SBATCH -J posture_gen_v4_chin
#SBATCH -p gpu
#SBATCH --gres=gpu:1
#SBATCH -c 8
#SBATCH --mem=32G
#SBATCH -o slurm-gen-v4-chin-%j.out
...
echo "=== Starting v4 Generation: 03_chin_rest ==="

python -m venv myenv_chin
source myenv_chin/bin/activate
...
python -u generate_dataset_openpose.py --class-name 03_chin_rest --num-variations 2500

deactivate
echo "=== Generation complete: 03_chin_rest ==="
